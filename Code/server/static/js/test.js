...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_superagent__ = __webpack_require__(77);
...
function getGeoJson () {
  ...
  return new Promise((resolve, reject) => {
    ...
    __WEBPACK_IMPORTED_MODULE_0_superagent___default.a.get(`${domain}${apiUrl}${endpoint}`)
      .end((err, asyncRes) => {
        if (err) {
          return reject(err);
        }
